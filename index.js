...
// 3. Create instances of the `BankBranch` class, such as `branchA` and `branchB`, with different branch information.

let branchA = new BankBranch({ name: 'Branch A', address: '1238 Castle Road', city: 'CapeTown' });
let branchB = new BankBranch({ name: 'Branch B', address: '4568 WillieCollins Street', city: 'Johannesburg' });

// 4. Verify that `branchA` and `branchB` are both referring to the same instance by comparing them using `===`.
